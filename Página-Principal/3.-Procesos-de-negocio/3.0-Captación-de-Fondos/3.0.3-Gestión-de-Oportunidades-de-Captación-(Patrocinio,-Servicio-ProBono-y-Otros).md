...
Para las oportunidades de tipo "Donación" y "Celebración Solidaria", una vez ganada la oportunidad, se deberá de generar una transacción con importe igual a la operación ganada. De este modo, se incluirá dentro del proceso de gestión de socios dónde se generará la remesa y gestionará el pago. Véase el apartado [3.2 Gestión de Socios](/Página-Principal/3.-Procesos-de-negocio/3.2-Gestión-de-Socios)
